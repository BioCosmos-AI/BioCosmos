#!/bin/bash
#SBATCH --job-name=add_common_names
#SBATCH --ntasks=1
#SBATCH --mem=64gb
#SBATCH --time=12:00:00
#SBATCH --output=add_common_names_%j.log
...
LOG_DIR="/blue/arthur.porto-biocosmos/tdeatherage3.gatech/logs"

# Run the script
python /home/tdeatherage3.gatech/unicom/embedding_and_clustering/add_common_names.py \
    --db-path "$DB_PATH" \
