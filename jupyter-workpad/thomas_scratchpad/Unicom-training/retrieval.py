...
#         pin_memory=True,
#         drop_last=True,
#         shuffle=True  # Add shuffle since we're not using DistributedSampler
#     )

#     # Skip DistributedDataParallel - just use the model directly
#     backbone = model  # This replaces the DistributedDataParallel wrapper
...
#     steps_per_epoch = len(dataset_train) // (world_size * args.batch_size) + 1
#     lr_scheduler = optim.lr_scheduler.OneCycleLR(
#         optimizer=opt,
#         max_lr=[args.lr, args.lr * args.lr_pfc_weight],
#         steps_per_epoch=steps_per_epoch,
